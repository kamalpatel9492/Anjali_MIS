<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RPT_INV_Invoice_Print.aspx.cs" Inherits="AnjaliMIS.Report.RPT_INV_Invoice_Print" %>
...
<body>
    <form id="form1" runat="server">
        <asp:DropDownList runat="server" ID="ddlInvoiceID"></asp:DropDownList>
        <br />
